 ...
 */
class ResizableEditText constructor(context: Context, attrs: AttributeSet, defStyle: Int) : EditText(context, attrs, defStyle), ResizableHelper.OnTextSizeChangeListener {
    private var mHelper: ResizableHelper? = null


    init {
        mHelper = ResizableHelper.create(this, attrs, defStyle)
    ...
    /**
     * Returns the [ResizableHelper] for this View.
     */
    fun getResizableHelper(): ResizableHelper? {
        return mHelper
    }
     ...
     * @attr ref me.grantland.R.styleable#ResizableTextView_minTextSize
     */
